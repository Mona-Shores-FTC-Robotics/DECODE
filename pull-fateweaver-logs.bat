...
REM The logs are stored in /sdcard/fateweaver/logs on the Android device
set ROBOT_LOG_PATH=/sdcard/fateweaver/logs

echo Pulling logs from robot path: %ROBOT_LOG_PATH%
echo.

REM Pull all files from the fateweaver logs directory
