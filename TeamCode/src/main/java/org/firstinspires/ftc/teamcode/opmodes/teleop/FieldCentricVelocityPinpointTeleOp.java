...
@TeleOp(name = "FieldCentricVelocityPinpointTeleOp", group = "Field Centric TeleOp")
public class FieldCentricVelocityPinpointTeleOp extends NextFTCOpMode {
    ...
    public void onUpdate() {
        ...
        robot.drive.driveFieldCentricVelocityPinpoint(request.fieldX, request.fieldY, request.rotation, request.precisionMode);
