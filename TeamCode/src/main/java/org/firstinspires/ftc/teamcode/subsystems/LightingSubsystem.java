...
public class LightingSubsystem implements Subsystem, IntakeSubsystem.LaneColorListener {
    ...
    public void clearLaneColors() {
        if (resetLaneColors()) updateLaneOutputs();
    }
    ...
    /** IMPORTANT: instance method again */
    public void setFollowSensorColors(boolean enabled) {
        ...
        if (enabled) {
            for (Map.Entry<LauncherLane, ArtifactColor> e : sensorLaneColors.entrySet()) {
                setLaneColor(e.getKey(), e.getValue());
            }
        }
    }
    ...
    public String getLightingStateString() { return state.name(); }
    public String getAllianceString() { return alliance.name(); }
    ...
    public boolean isLeftIndicatorPresent() {
        LaneIndicator i = laneIndicators.get(LauncherLane.LEFT);
        return i != null && i.isPresent();
    }
    ...
    public boolean isCenterIndicatorPresent() {
        LaneIndicator i = laneIndicators.get(LauncherLane.CENTER);
        return i != null && i.isPresent();
    }
    ...
    public boolean isRightIndicatorPresent() {
        LaneIndicator i = laneIndicators.get(LauncherLane.RIGHT);
        return i != null && i.isPresent();
    }
