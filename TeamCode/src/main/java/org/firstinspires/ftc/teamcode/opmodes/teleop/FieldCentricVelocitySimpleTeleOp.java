...
/**
 * Minimal velocity-control TeleOp useful for drivetrain debugging.
 * Converts joystick inputs directly into wheel velocity using setVelocity,
 * without slew limiting or odometry feedback.
 */
@TeleOp(name = "FieldCentricVelocitySimple", group = "Field Centric TeleOp")
public class FieldCentricVelocitySimpleTeleOp extends NextFTCOpMode {
