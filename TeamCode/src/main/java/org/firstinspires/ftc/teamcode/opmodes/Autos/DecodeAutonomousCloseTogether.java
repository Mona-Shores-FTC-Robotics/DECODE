...
public class DecodeAutonomousCloseTogether extends OpMode {
    ...
    public void init() {
        ...
        applyAlliance(activeAlliance, CloseTogetherCommand.getDefaultStartPose());
...
//        updateProximityFeedback();
    ...
    private void applyInitSelections(AutoPrestartHelper.InitStatus status) {
        ...
        if (status.alliance != activeAlliance) {
            ...
            Pose defaultPose = lastDetectedStartPosePedro != null
                ...
                : CloseTogetherCommand.getDefaultStartPose();
    ...
    private void updateExpectedStartPose() {
        ...
        Pose expectedPose = AutoField.poseForAlliance(
                CloseTogetherCommand.waypoints.startX,
                CloseTogetherCommand.waypoints.startY,
                CloseTogetherCommand.waypoints.startHeading,
                activeAlliance
        );
