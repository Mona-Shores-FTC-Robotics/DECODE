...
public class RobotState {
    ...
    private static final AtomicReference<String> robotName = new AtomicReference<>("UNKNOWN");
    ...
    public static void setRobotName(String value) { robotName.set(value == null ? "DECODE_19429" : value); }
