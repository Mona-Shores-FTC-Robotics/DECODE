    ...
    public static Command create(Robot robot, Alliance alliance, Pose startOverride) {
        ...
        Command mainSequence = new SequentialGroup(
                ...
                new ParallelDeadlineGroup(
                    buildPath(robot, actualStart, mirror(launchFar(), alliance), null, false, config.maxPathPower),
            ...
            buildPath(robot, mirror(artifactsAllianceWall(), alliance), mirror(launchFar(), alliance),
                    mirror(leaveControl0(), alliance), false, config.maxPathPower),

            new TryRelocalizeForShotCommand(robot.drive, robot.vision),
            launcherCommands.launchAccordingToMode(false),

            // Pickup Artifact Set 3
            buildPath(robot, mirror(launchFar(), alliance), mirror(artifactsSet3(), alliance),
                    mirror(artifactsSet3Control0(), alliance), false, config.maxPathPower),

            // Return and launch set 3
            buildPath(robot, mirror(artifactsSet3(), alliance), mirror(launchFar(), alliance),
                    null, false, config.maxPathPower),
            ...
            buildPath(robot, mirror(launchFar(), alliance), mirror(artifactsSet2(), alliance),
                    mirror(artifactsSet2Control0(), alliance), false, config.maxPathPower),
            ...
            new ConditionalFinalLaunchCommand(
                    ...
                    new SequentialGroup(
                            buildPath(robot, mirror(artifactsSet2(), alliance), mirror(launchFar(), alliance),
                                    null, false, config.maxPathPower),
                    ...
                    new SequentialGroup(
                            buildPath(robot, mirror(artifactsSet2(), alliance), mirror(readyForTeleop(), alliance),
                                    null, false, config.maxPathPower)
                    )
            )
        );
