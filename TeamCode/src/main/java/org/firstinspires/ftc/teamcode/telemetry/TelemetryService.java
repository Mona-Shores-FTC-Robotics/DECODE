...
public class TelemetryService {
    ...
    // ========================================================================
    // Helper methods to log to both FTC Dashboard and KoalaLog simultaneously
    // ========================================================================

    /**
     * Logs a double value to both FTC Dashboard packet and KoalaLog.
     */
    ...
    /**
     * Logs a string value to both FTC Dashboard packet and KoalaLog.
     */
    ...
    /**
     * Logs a boolean value to both FTC Dashboard packet and KoalaLog.
     */
    ...
    /**
     * Logs an integer value to both FTC Dashboard packet and KoalaLog.
     */
    private void logInteger(TelemetryPacket packet, String key, int value) {
        packet.put(key, value);
        KoalaLog.logInteger(key, value);
    }
